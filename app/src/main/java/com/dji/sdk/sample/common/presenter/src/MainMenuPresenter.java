...
import com.dji.sdk.sample.common.activity.AndroidPcConnectionActivity;
...
public class MainMenuPresenter implements View.OnClickListener {
    ...
    public void onClick(View view)
    {
        ...
        {
            Intent reconstructLiveIntent = new Intent(context_, AndroidPcConnectionActivity.class);
